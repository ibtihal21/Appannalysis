...
def main():
    ...
    st.subheader("Select your desired topic to analyse :")
    ...
    st.image(image, caption='Analysing sentiments using Twitter ',use_column_width=True)
    
    
    # Collect Input from user :
    Topic = str()
    Topic = str(st.text_input("Enter the topic  (Press Enter )"))
    ...
    st.sidebar.info("A Twitter Sentiment analysis Project that will help us get a feel of the overall mood of the people on Twitter regarding the topic chosen.")
    st.sidebar.text("Built with Streamlit")
    
    #st.sidebar.header("For Any Queries/Suggestions Please reach out at :")
    st.sidebar.info("Realised By Us")
